...
ตัวย่อ RSC ตั้งเลียนแบบชื่อย่อหุ้นในตลาดจริง (แบบเดียวกับ PTT หรือ AOT ในตลาดหุ้นไทย) — ไม่ใช่ศัพท์การเงินที่ต้องจำ แค่ชื่อเล่นของบริษัทที่จะเจอไปทั้งหลักสูตร
...
1. เล่น [**เกมจำลอง** รอบที่ 1](../../sim/sim.html?unlock=1) — คิวคนไข้ล้นแต่เก้าอี้ตรวจไม่พอ เลือกวิธีขยาย 1 ใน 4 ทาง แล้วดูผล 5 ปี (ตัวเลขทุกตัวคำนวณจากงบใน `knowledge/case-company.md` ไม่มีค่าที่ตั้งไว้ล่วงหน้า — ถ้าไม่เชื่อให้กดคำนวณตามได้)
2. [ทำควิซ](quiz.html) — ตอบผิดไม่เป็นไร ข้อที่ผิดจะวนกลับมาให้ทบทวน
3. [ทำข้อสอบเคส](case.html) — **โดยไม่เปิดเนื้อหากลับมาดู**
4. เขียนสมุดบันทึก — เปิดไฟล์ `notes.md` ในโฟลเดอร์นี้ด้วย Notepad แล้วอธิบาย 5 ข้อข้างบนด้วยภาษาตัวเอง **โดยไม่เปิดไฟล์นี้** — ข้อไหนเขียนไม่ออกคือข้อที่ยังไม่เข้าใจจริง (วิธีละเอียดอยู่ท้ายหน้าข้อสอบเคส)
